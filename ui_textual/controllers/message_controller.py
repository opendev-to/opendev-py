...
class MessageController:
    ...
    def _set_processing_state(self, active: bool) -> None:
        ...
        debug_log(
            "MessageController",
            f"_set_processing_state called with active={active}, current={app._is_processing}",
        )
        ...
        debug_log(
            "MessageController", f"_is_processing changing from {app._is_processing} to {active}"
        )
