...
class WebFetchTool:
        ...
        try:
            ...
            async with AsyncWebCrawler(config=browser_config) as crawler:
                ...
                if deep_crawl:
                    ...
                    content, page_metadata = self._format_deep_crawl_results(
                        successful_pages, extract_text
                    )
    ...
    def _build_deep_strategy(
        ...
        *,
        ...
        if strategy_key not in strategy_map:
            raise ValueError(
                f"Unsupported crawl_strategy '{strategy}'. Use bfs, dfs, or best_first."
            )
    ...
    def _format_deep_crawl_results(
        self, pages: Sequence[Any], extract_text: bool
