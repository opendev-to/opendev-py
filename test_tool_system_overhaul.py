...
class TestMemoryTools:
    def test_import(self):
        ...
        from opendev.core.context_engineering.tools.handlers.memory_handlers import (
            MemoryToolHandler,
        )
...
class TestSessionTools:
    def test_import(self):
        from opendev.core.context_engineering.tools.implementations.session_tools import (
            SessionTools,
        )
        from opendev.core.context_engineering.tools.handlers.session_handlers import (
            SessionToolHandler,
        )
...
class TestBrowserTool:
    def test_import(self):
        ...
        from opendev.core.context_engineering.tools.handlers.browser_handlers import (
            BrowserToolHandler,
        )
...
class TestScheduleTool:
    def test_import(self):
        from opendev.core.context_engineering.tools.implementations.schedule_tool import (
            ScheduleTool,
        )
    ...
    def test_list_empty(self):
        ...
        with patch(
            "opendev.core.context_engineering.tools.implementations.schedule_tool._SCHEDULES_FILE",
...
class TestParamNormalizer:
    ...
    def test_camel_to_snake(self):
        ...
        result = normalize_params(
            "edit_file", {"filePath": "test.py", "oldContent": "a", "newContent": "b"}
        )
    ...
    def test_path_resolution_absolute(self):
        ...
        result = normalize_params(
            "test", {"file_path": "/absolute/path.py"}, working_dir="/project"
        )
...
class TestMiddleware:
    ...
    def test_builtin_sanitizer_middleware(self):
        ...
        assert cont is True
        result = mw.after(
            "run_command", {}, {"success": True, "output": "x" * 20000}, ToolExecutionContext()
        )
        assert "truncated" in result["output"]
...
class TestPatchTool:
    ...
    def test_extract_files_standard_format(self):
        ...
        files = PatchTool._extract_files("--- a/old.py\n" "+++ b/new.py\n")
...
class TestSchemaBuilderIntegration:
    def test_builder_with_provider(self):
        ...
        for s in schemas:
            ...
            assert (
                "additionalProperties" not in params
