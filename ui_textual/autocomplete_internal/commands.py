...
BUILTIN_COMMANDS.register(
    SlashCommand("task", "show output from a background task (usage: /task <id>)")
)
...
BUILTIN_COMMANDS.register(
    SlashCommand("skills", "create and manage custom skills with AI assistance")
)
