"""Native swecli ACE Delta operations implementation.

This module re-implements the ACE delta operations for playbook mutations
...
class DeltaOperation:
    ...
    def from_json(cls, payload: Dict[str, object]) -> DeltaOperation:
        """Create DeltaOperation from JSON payload."""
    ...
    def to_json(self) -> Dict[str, object]:
        """Convert DeltaOperation to JSON payload."""
...
class DeltaBatch:
    ...
    def from_json(cls, payload: Dict[str, object]) -> DeltaBatch:
        """Create DeltaBatch from JSON payload."""
    ...
    def to_json(self) -> Dict[str, object]:
        """Convert DeltaBatch to JSON payload."""
        return {
