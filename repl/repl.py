...
class REPL:
    ...
    def _init_hooks(self):
        ...
        try:
            ...
            if (
                hasattr(self.runtime_suite, "subagent_manager")
                and self.runtime_suite.subagent_manager
            ):
    ...
    def start(self, *, startup_type: str = "startup") -> None:
        ...
        if self._hook_manager:
            ...
            self._hook_manager.run_hooks(HookEvent.SESSION_START, match_value=startup_type)
