...
class Reflector:
    ...
    def __init__(
        ...
        *,
        ...
        self.retry_prompt = (
            retry_prompt if retry_prompt is not None else get_reminder("json_retry_simple")
        )
        ...
        **kwargs: Any,
        ...
        base_prompt = self.prompt_template.format(
            ...
            agent_response=(
                ...
                if len(agent_response.content) > 1000
                else agent_response.content
            ),
...
class Curator:
    ...
    def __init__(
        ...
        *,
        ...
        self.llm_client = llm_client
        self.prompt_template = (
            prompt_template if prompt_template is not None else load_prompt("memory/curator_prompt")
        )
        self.max_retries = max_retries
        self.retry_prompt = (
            retry_prompt if retry_prompt is not None else get_reminder("json_retry_with_fields")
        )
