...
class TestACEIntegration:
    ...
    def test_playbook_creation(self):
        ...
        bullet = playbook.add_bullet(
            section="file_operations", content="List directory before reading files"
        )
    ...
    def test_agent_response_creation(self):
        ...
        response = AgentResponse(
            content="Test response content", tool_calls=[{"function": {"name": "read_file"}}]
        )
    ...
    def test_playbook_delta_operations(self):
        ...
        delta = DeltaBatch(
            ...
            operations=[
                DeltaOperation(type="ADD", section="new_section", content="New strategy"),
                DeltaOperation(
                    type="TAG", section="test", bullet_id=bullet.id, metadata={"helpful": 1}
                ),
            ],
        )
