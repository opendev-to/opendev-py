...
class ValidatedMessageList(list):
    ...
    def add_tool_result(self, tool_call_id: str, content: str) -> None:
        ...
        with self._lock:
            ...
            super().append({"role": "tool", "tool_call_id": tool_call_id, "content": content})

    def add_tool_results_batch(self, tool_calls: list[dict], results_by_id: dict[str, Any]) -> None:
        ...
        with self._lock:
            for tc in tool_calls:
                ...
                super().append({"role": "tool", "tool_call_id": tc_id, "content": content})
    ...
    def _auto_complete_pending(self, source: str) -> None:
        ...
        logger.warning(
            "ValidatedMessageList: Auto-completing %d pending tool results " "before %s: %s",
